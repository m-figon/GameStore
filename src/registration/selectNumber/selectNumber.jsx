...
class SelectNumber extends Component {
    ...
    render() {
        ...
        return (
            <select onFocus={this.props.tooltipShowHandler} onBlur={this.props.tooltipHideHandler} id={this.props.id} value={this.state.selectValue} onChange={(e) => this.afterOnChange(e)}><option value="none">{this.props.value}</option>{array}</select>
        );
    }
